...
#Region "Farmacia Nota Entrega"
    Public Shared Function L_GetPersonas(sucursal As Integer) As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        ...
        _Tabla = D_Datos_Tabla("a.*",
                               "TC002 a", " cbnumi = cbnumi and cbsuc =" + sucursal.ToString)
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
...
#Region "Zona"
    ...
    Public Shared Function L_ZonaCabecera_General(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Return _Ds
    End Function
    Public Shared Function L_prListarChoferesRutas(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 27))
        _listParam.Add(New Datos.DParametro("@ibalm", sucursal))
    ...
    Public Shared Function L_prGuardarAsignacion(dt As DataTable, chofer As Integer) As Boolean
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 46))
        _listParam.Add(New Datos.DParametro("@TabId", "", dt))
    ...
    Public Shared Function TraerPedidosAsignados(chofer As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_ZonaCabecera_GeneralCompleto(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Return _Ds
    End Function
    Public Shared Function L_ZonaCabecera_GeneralCompleto1(_Modo As Integer, _Cadena As String, sucursal As String) As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String
        If _Modo = 0 Then
            _Where = "lacity = c.cenum  and b.cdcon = c.cecon  and b.cdcon = 4 " _
                    + " and laprovi = cc.cenum  and bb.cdcon = cc.cecon  and bb.cdcon = 3 " _
                    + " and lazona = ccc.cenum  and bbb.cdcon = ccc.cecon  and bbb.cdcon = 2 " _
                    + " and lanumi in (select lcnumi from TL0012 b inner join TC002 c on b.lccbnumi = c.cbnumi where cbsuc = " + sucursal + "  group by lcnumi) "
        Else
            _Where = _Cadena
        End If
    ...
    Public Shared Sub L_ZonaCabecera_Grabar(ByRef _numi As String, _city As String, _provi As String, _zona As String, _color As String, catPre As String)
        Dim _Actualizacion As String
        Dim _Err As Boolean
        Dim _Tabla As DataTable
        ...
        _Actualizacion = "'" + Date.Now.Date.ToString("yyyy/MM/dd") + "', '" + Now.Hour.ToString + ":" + Now.Minute.ToString + "' ,'" + L_Usuario + "'"
        Dim Sql As String
        Sql = _numi + "," + _city + "," + _provi + "," + _zona + ",'" + _color + "'," + _Actualizacion + ", " + catPre
    ...
    End Sub
    Public Shared Sub L_ZonaCabacera_Modificar(_numi As String, _city As String, _provi As String, _zona As String, _color As String, catPre As String)
        Dim _Err As Boolean
        Dim Sql, _where As String
...
#Region "Metodos Guido"
    Public Shared Function L_ProductosPedido_General(_Modo As Integer, Optional _CatProd As String = "", Optional _CatClie As String = "", Optional _ordenEspecifico As String = "0") As DataTable
        ...
        End If
        _Tabla = D_Datos_Tabla("canumi,cadesc,chprecio,caimg,castc,cagr4, " + _ordenEspecifico + " as orden ,caconv", "TC001,TC003", _Where + " order by orden,canumi")
    ...
    Public Shared Function L_ProductosPedido_GeneralNuevoStock2(_CatClie As String, _alm As String, Mayor0 As Boolean) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@catCLiente", _CatClie))
        _listParam.Add(New Datos.DParametro("@sucursal", _alm))
        _listParam.Add(New Datos.DParametro("@cantP", IIf(Mayor0 = True, 1, 0)))
        _listParam.Add(New Datos.DParametro("@cnuact", L_Usuario))

        _Tabla = D_ProcedimientoConParam("sp_dg_TL001", _listParam)
    ...
    Public Shared Function L_ProductosPedido_GeneralNuevoStock(_Modo As Integer, Optional _CatClie As String = "", Optional _alm As String = "", Optional Mayor0 As Boolean = True) As DataTable
        ...
        _Tabla = D_Datos_Tabla("canumi,cacod,cadesc,chprecio,caimg,castc,cagr4,cagr3, (iacant-ISNULL(( select SUM(obpcant) FROM TO001,TO0011 
                             WHERE obcprod= canumi and oanumi = obnumi AND oaap = 1 AND to001.oanumi NOT IN (Select oacoanumi from to001C where oacnconc > 0) AND oaest IN (1, 2)), 0)) AS iacant,caconv", "TC001,TC003, TI001", _Where + " order by canumi")
    ...
    Public Shared Function L_ProductosPedido_General2(_Modo As Integer, Optional _CatProd As String = "", Optional _CatClie As String = "", Optional _ordenEspecifico As String = "0", Optional _numiCli As String = "0") As DataTable
        ...
        End If
        _Tabla = D_Datos_Tabla("canumi,cadesc,chprecio,caimg,castc,cagr4, " + _ordenEspecifico + " as orden,caconv", "TC001,TC003,TC0042", _Where + " order by orden,canumi")
...
#Region "Pedidos"
    ...
    Public Shared Function L_PedidoCabecera_GeneralNuevo(estado As Integer, oaap As Integer, codZona As Integer, codRepa As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@oaap", oaap))
        _listParam.Add(New Datos.DParametro("@codzona", codZona))
        _listParam.Add(New Datos.DParametro("@codRepa", codRepa))
    ...
    Public Shared Function L_PedidoCabecera_GeneralSoloRepartidor(_Modo As Integer, Optional _Cadena As String = "") As DataTable
        ...
        _Tabla = D_Datos_Tabla("DISTINCT oanumi,oafdoc,oahora,cccod,ccdesc,ccdirec,cctelf1,cccat," _
                              ...
                              "TO001,TC004,TC0051,TL001,TL0012,TO001A, TC002",
                               _Where + "order by oanumi") ' and oanumi not in (select ofnumiped from TO0014) 
        Return _Tabla
    End Function
    ...
    Public Shared Sub L_PedidoCabecera_Grabar(ByRef _numi As String, _fecha As String, _hora As String, _idCli As String, _zona As String, distribuidor As String, _obs As String, _estado As String, _activoPasivo As String, _pedGen As String, factura As Integer)
        Dim _Actualizacion As String
        Dim _Err As Boolean
        Dim _Tabla As DataTable
        ...
        _Actualizacion = "'" + Date.Now.Date.ToString("yyyy/MM/dd") + "', '" + Now.Hour.ToString + ":" + Now.Minute.ToString + "' ,'" + L_Usuario + "'"
        Dim Sql As String
        Sql = _numi + ",'" + Date.Now.Date.ToString("yyyy/MM/dd") + "','" + _hora + "'," + _idCli + "," + _zona + "," + distribuidor + ",'" + _obs + "',''," + _estado + "," + _activoPasivo + "," + _pedGen + ",0," + _Actualizacion + "," + factura.ToString
    ...
    Public Shared Sub L_PedidoCabacera_Modificar(_numi As String, _fecha As String, _hora As String, _idCli As String, _zona As String, distribuidor As String, _obs As String, _estado As String, factura As Integer)
        Dim _Err As Boolean
        Dim Sql, _where As String
    ...
    Public Shared Sub BorrarMovimientoEntrega(_numi As Integer)
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_PedidoGenerarCopia(numi As String) As String
        ...
        _dtCabOri = D_Datos_Tabla("oanumi,oafdoc,oahora,oaccli,oazona,oarepa,oaobs,oaobs2,oaest,oaap,oapg,oaestfac", "TO001", _Where)
        _dtDetOri = L_PedidoDetalle_General(-1, numi)

        'grabar cabecera
        Dim numiNew, numiCli, numiZona, distribuidor, obs, estafact As String
        ...
        estafact = _dtCabOri.Rows(0).Item("oaestfac").ToString
        numiNew = ""
        L_PedidoCabecera_Grabar(numiNew, Now.Date.ToString("yyyy/MM/dd"), Now.Hour.ToString("00") + ":" + Now.Minute.ToString("00"), numiCli, numiZona, distribuidor, obs, "1", "1", "2", estafact)
    ...
    Public Shared Function L_PedidoDetalle_GeneralNuevo(_Modo As Integer, Optional _idCabecera As String = "") As DataTable
        ...
        End If
        _Tabla = D_Datos_Tabla("obnumi,obcprod, cacod, cadesc,(obpcant/caconv) as caja,obpcant,obpbase,obptot,isnull(obporcdesc,0) obporcdesc,obdesc,obtotal,obfamilia, obcampo1, iacant,caconv", "TO0011,TC001, TI001", _Where)
        Return _Tabla
    End Function
    ...
    End Sub
    Public Shared Sub L_PedidoDetalle_GrabarNuevo(_idCabecera As String, _codProd As String, _cantidad As String, _precio As String, _subTotal As String, _desc As String, _total As String, _flia As String, _atributo As String, _porcdesc As String)
        Dim _Err As Boolean
        Dim Sql As String
        ...
        Sql = _idCabecera + ",'" + _codProd + "'," + _cantidad + "," + _precio + "," + _subTotal + "," + _desc + "," + _total + "," + _flia + "," + _atributo + "," + campo2 + "," + _porcdesc
        _Err = D_Insertar_Datos("TO0011", Sql)
    End Sub
    ...
    Public Shared Function ListarProductoxPedidoFactura(idPedido As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 361))
        _listParam.Add(New Datos.DParametro("@pedido", idPedido))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        Return _Tabla
    ...
    Public Shared Function L_prListaPedidos(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 22))
        _listParam.Add(New Datos.DParametro("@numi", sucursal))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_prListaPedidosPorFecha(fechaI As String, fechaf As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function GrabarMontosPedido(oanumi As Integer, credito As Double, total As Double) As Boolean
        Dim _resultado As Boolean
        '@olnumi,@olnumichof ,@olnumiconci ,@olfecha ,@newFecha ,@newHora ,@oluact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@oanumi", oanumi))
        _listParam.Add(New Datos.DParametro("@credito", credito))
        _listParam.Add(New Datos.DParametro("@olcredito", total))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
    ...
    '    Return _Tabla
    'End Function
    Public Shared Function evaluarEntrega(codPedido As Integer, almacen As Integer) As Boolean
        Dim _resultado As Boolean
        '@olnumi,@olnumichof ,@olnumiconci ,@olfecha ,@newFecha ,@newHora ,@oluact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        Else
            If _Tabla.Rows(0).Item("oacnconc") > 0 Then
                _resultado = True
            Else
                If _Tabla.Rows(0).Item("oaccbnumi") = almacen Then
                    _resultado = True
                Else
                    _resultado = False
                End If
    ...
    Public Shared Function EntregadePedido(codPedido As Integer, estado As Integer, fecha As String, hora As String, usuario As String) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@pedido", codPedido))
        _listParam.Add(New Datos.DParametro("@olnumi", estado))
        _listParam.Add(New Datos.DParametro("@fechai", fecha))
        _listParam.Add(New Datos.DParametro("@fvaccont", hora))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        ...
        If _Tabla.Rows.Count = 0 Then
            _resultado = True
        Else
            If _Tabla.Rows(0).Item("contado") > 0 Then
                _resultado = True
            Else
                _resultado = False
            End If
...
#Region "TC001 Productos"
    ...
    Public Shared Function L_fnProductoGrabar(ByRef numi As String, cod As String, desc As String, desc2 As String,
                                              ...
                                              peso As Integer, codAct As Integer, codUniM As Integer, codSin As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@codAct", codAct))
        _listParam.Add(New Datos.DParametro("@codUniM", codUniM))
        _listParam.Add(New Datos.DParametro("@codSin", codSin))
...
#Region "Clientes"
    ...
    Public Shared Function L_prCargarClienteAll(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prTraerUsuarioVentaDirecta(tipo As Integer, sucursal As Integer) As Integer
        Dim _Tabla As DataTable
        Dim usuario As Integer = 4

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 9))
        _listParam.Add(New Datos.DParametro("@sucursal", sucursal))
        _listParam.Add(New Datos.DParametro("@estado", tipo))
        _listParam.Add(New Datos.DParametro("@cnuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_dg_TL001", _listParam)

        If _Tabla.Rows.Count > 0 Then
            usuario = _Tabla.Rows(0).Item("cbnumi")
        End If
        Return usuario
    End Function
    ...
    Public Shared Function L_fnGrabarCliente(ByRef numi As String, cod As String, desc As String, zona As String,
                                             ...
                                             jueves As Integer, viernes As Integer, sabado As Integer, domingo As Integer,
                                             dtimagenes As DataTable, usuesp As Integer, apellido As String, customerid As String, docFact As String) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@apellido", apellido))
        _listParam.Add(New Datos.DParametro("@customerid", customerid))
        _listParam.Add(New Datos.DParametro("@docFact", docFact))
    ...
    Public Shared Function L_fnModificarCliente(ByRef numi As String, cod As String, desc As String, zona As String,
                                                ...
                                                frecvisita As String, lunes As Integer, martes As Integer, miercoles As Integer,
                                                jueves As Integer, viernes As Integer, sabado As Integer, domingo As Integer,
                                                dtImagenes As DataTable, usuesp As Integer, apellido As String, docFact As String, customerId As String) As Boolean
        Dim _resultado As Boolean
    ...
    Public Shared Function L_fnClientes(sucursal As Integer, estado As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 3))
        _listParam.Add(New Datos.DParametro("@ccest", estado))
        _listParam.Add(New Datos.DParametro("@cczona", sucursal))
        _listParam.Add(New Datos.DParametro("@ccuact", L_Usuario))
    ...
    Public Shared Function L_fnClientes2(estado As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_GetZonasCPZ(sucursal As Integer) As DataTable
        'Dim _Tabla As DataTable
        ''Dim _Ds As New DataSet
        'Dim _Where As String = " a.lazona =c.cenum " _
        '                        + " and c.cecon = 2 " _
    ...
    Public Shared Function L_GetListarZonasDistribucion(sucursal As Integer) As DataTable
    ...
    Public Shared Function L_GetListarChoferesDistribucion(sucursal As Integer) As DataTable
    ...
    Public Shared Function L_GetZonasCPZ2(rep As Integer) As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String = " a.lanumi =b.lcnumi " _
                                + " and a.lazona =c.cenum " _
                                + " and c.cecon = 2 " _
                                + " and a.laprovi = cc.cenum " _
                                + " and cc.cecon = 3 " _
                                + " and a.lacity = ccc.cenum " _
                                + " and ccc.cecon = 4 and b.lccbnumi = " + rep.ToString
        _Tabla = D_Datos_Tabla("a.lanumi, ccc.cedesc as city, cc.cedesc as prov, c.cedesc as zona ",
                               "TL001 a,TL0012 b, TC0051 c, TC0051 cc, TC0051 ccc",
                               _Where)
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
...
#End Region
    ...
    Public Shared Function L_prListarVisitas(usuario As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 22))
    ...
    Public Shared Function L_prListarDetalleVentas(usuario As Integer, fechaI As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prListarClientesZona(zona As Integer, fechaI As String, fechaF As String, distribuidor As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 23))
        _listParam.Add(New Datos.DParametro("@numi", zona))
        _listParam.Add(New Datos.DParametro("@distribuidor", distribuidor))
        _listParam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
...
#Region "Usuarios"
    ...
    Public Shared Function L_Usuario_General2(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Else
            _Where = "ZY003.ydnumi=ZY003.ydnumi and ZY002.ybnumi=ZY003.ydrol " + _Cadena
        End If
        _Tabla = D_Datos_Tabla("ZY003.ydnumi,ZY003.yduser,ZY003.ydpass,ZY003.ydest,ZY003.ydcant,ZY003.ydfontsize,ZY002.ybnumi,ZY002.ybrol,ZY003.ydsuc", "ZY003,ZY002", _Where + " order by ydnumi")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    ...
    Public Shared Function L_Usuario_General3(_Modo As Integer, Optional _Cadena As String = "") As DataSet
        ...
        Return _Ds
    End Function
    Public Shared Sub L_Usuario_Grabar(ByRef _numi As String, _user As String, _pass As String, _rol As String, _estado As String, _cantDias As String, _tamFuente As String, sucursal As Integer)
        Dim _Actualizacion As String
        Dim _Err As Boolean
        Dim _Tabla As DataTable
        ...
        Dim Sql As String
        Sql = _numi + ",'" + _user + "'," + _rol + ",'" + _pass + "','" + _estado + "'," + _cantDias + "," + _tamFuente + "," + _Actualizacion + "," + sucursal.ToString
        _Err = D_Insertar_Datos("ZY003", Sql)
    End Sub
    Public Shared Sub L_Usuario_Modificar(_numi As String, _user As String, _pass As String, _rol As String, _estado As String, _cantDias As String, _tamFuente As String, sucursal As Integer)
        Dim _Err As Boolean
        Dim Sql, _where As String
...
#Region "CATEGORIA COMISIONES"
    ...
    Public Shared Function L_prReporteVentasComisionUno1(_fechaI As String, _FechaF As String, _codPrevendedor As String, Proveedor As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasVendedorTodos(_fechaI As String, _FechaF As String, _Tipo As Integer, Proveedor As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function L_prReporteVentasDetalladas(_fechaI As String, _FechaF As String, vendedor As Integer, cliente As Integer, prod As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 24))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        _listParam.Add(New Datos.DParametro("@distribuidor", vendedor))
    ...
    Public Shared Function L_prReporteVentasEfectividadCliente(_fechaI As String, _FechaF As String, cod As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 26))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", _FechaF))
        _listParam.Add(New Datos.DParametro("@prevendedor", cod))

        _Tabla = D_ProcedimientoConParam("sp_mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function

    Public Shared Function L_prReporteVentasEfectividadProducto(_fechaI As String, _FechaF As String, cod As Integer, cliente As Integer, prod As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 27))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function ReporteDespachoxProducto(idchofer As Integer, Estado As Integer, fechaI As String, fechaF As String) As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@numi", Estado))
        _listParam.Add(New Datos.DParametro("@fechaI", fechaI))
        _listParam.Add(New Datos.DParametro("@fechaF", fechaF))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
...
#Region "TC002 PERSONAL"
    ...
    Public Shared Function L_fnPersonal(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function VerificarCamionRepartidor(id As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@numi", id))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        ...
        Return _Tabla
    End Function
    Public Shared Function VerificarCamionRepartidor2(id As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _listParam.Add(New Datos.DParametro("@numi", id))
        _listParam.Add(New Datos.DParametro("@cat", sucursal))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_fnGrabarPersonal(ByRef numi As String, desc As String, direc As String, telef As String,
                                              ...
                                              eciv As String, plan As String, reloj As String, cbalmacen As Integer,
                                              precio As Integer, zona As Integer, pedido As Integer, hora As String, sucursal As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@pedido", pedido))
...
#Region "MApasClientes"
    Public Shared Function L_prMapaCLienteGeneral(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "TL001 Zona"
    ...
    Public Shared Function L_fnZonaGeneral(sucursal As Integer) As DataTable
        'Dim Tabla As DataTable
    ...
    Public Shared Function L_fnArmarGrillaRepartidor(sucursal As Integer) As DataTable
    ...
    Public Shared Function L_fnArmarGrillaVendedor(sucursal As Integer) As DataTable
...
#Region "TI002 MOVIMIENTOS DE SALIDA DEL CHOFER BIOPETROL"
    ...
    Public Shared Function TraerPedidosEntregados(_chofer As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prMovimientoChoferGrabar(ByRef _ibid As String, _ibfdoc As String, _ibconcep As Integer, _ibobs As String, _ibidchof As Integer, _idConciliacion As Integer, ibalm As Integer) As Boolean
        Dim _resultado As Boolean
        ...
        _listParam.Add(New Datos.DParametro("@ibalm", ibalm))
...
#Region "TI002 MOVIMIENTOS DE SALIDA DE PRODUCTOS PARA EL CHOFER BIOPETROL"
    ...
    Public Shared Function L_prMovimientoChoferGeneralSalida(_idconcepto As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prMovimientoChoferGeneralSalidaTop20(_idconcepto As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prMovimientoChoferGeneralEntrada(_idconcepto As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prMovimientoChoferGeneralEntradaTop20(_idconcepto As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prMovimientoChoferListarProductosSalida(dt As DataTable, sucursal As Integer) As DataTable
    ...
    Public Shared Function L_prMovimientoChoferModificarSalida(ByRef _ibid As String, _ibfdoc As String, _ibconcep As Integer, _ibobs As String, _ibidchof As Integer, _detalle As DataTable, _icibid As String, ibalm As Integer) As Boolean
        Dim _resultado As Boolean
    ...
    Public Shared Function L_prVerificarStock(_canumi As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "TI002 MOVIMIENTOS DE SALIDA DEL CHOFER BIOPETROL"
    ...
    Public Shared Function L_prMovimientoChoferListarChoferes() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prListarChoferesPedidosPendientes(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "TI002 Movimientos"
    ...
    Public Shared Function L_fnMovimientoGeneral(est As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 3))
        _listParam.Add(New Datos.DParametro("@ibidOrigen", sucursal))
        _listParam.Add(New Datos.DParametro("@est", est))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_fnMovimientoListarSucursales(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@alm", sucursal))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function L_fnStockCatalogo() As DataTable
        Dim _Tabla As DataTable
...
#Region "TCA001 Compra"
    ...
    Public Shared Function L_fnCProductosCompra(proveedor As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 10))
        _listParam.Add(New Datos.DParametro("@est", proveedor))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
...
#Region "TO005 Caja"
    ...
    Public Shared Function L_prCajaGrabar(ByRef _olnumi As String, _olnumichof As String, _olnumiconci As Integer, _olfecha As String,
                                          olmrec As String, _dt As DataTable, olCredito As Decimal, olTipoCambio As Decimal,
                                          olGasto As Decimal, dtCortes As DataTable) As Boolean ', dtDepositos As DataTable) As Boolean
        Dim _resultado As Boolean
        '@olnumi,@olnumichof ,@olnumiconci ,@olfecha ,@newFecha ,@newHora ,@oluact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@olGasto", olGasto))
        _listParam.Add(New Datos.DParametro("@olTipoCambio", olTipoCambio))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _listParam.Add(New Datos.DParametro("@TO001", "", _dt))
        _listParam.Add(New Datos.DParametro("@TO0051", "", dtCortes))
        ' _listParam.Add(New Datos.DParametro("@TO0053", "", dtDepositos))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        ...
        Return _resultado
    End Function
    Public Shared Function L_prReporteCreditoGeneral(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prCortesCierreCaja(olnumi As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 50))
        _listParam.Add(New Datos.DParametro("@olnumi", olnumi))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
    ...
    Public Shared Function L_prReporteFlujoIngresosVentas(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteFlujoIngresosCobros(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prReporteFlujoEgresos(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prReporteFlujoCredito(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteFlujoGeneral(fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prObtenerReporteCierres(fechai As String, fechaf As String, chofer As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function updateCliente(ccnumi As String, NumFactura As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 19))
        _listParam.Add(New Datos.DParametro("@ccnumi", ccnumi))
        _listParam.Add(New Datos.DParametro("@customerid", NumFactura))
        _Tabla = D_ProcedimientoConParam("sp_go_TC004", _listParam)
        Return _Tabla
    End Function

    Public Shared Function updateFactura(ccnumi As String, NumFactura As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@idFactura", ccnumi))
        _listParam.Add(New Datos.DParametro("@numFactura", NumFactura))
    ...
    Public Shared Function L_prListarConciliacion(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _listParam.Add(New Datos.DParametro("@numi", sucursal))
    ...
    Public Shared Function L_prListarZona(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 10))
        _listParam.Add(New Datos.DParametro("@numi", sucursal))
    ...
    Public Shared Function L_prListarClienteZona(numizona As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prListarCliente(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 12))
        _listParam.Add(New Datos.DParametro("@numi", sucursal))
    ...
    Public Shared Function L_fnCobranzasDetalle(_numi As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnListarEmpleado(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 13))
        _listParam.Add(New Datos.DParametro("@tdnumi", sucursal))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TV00121Cheque", _listParam)
    ...
    Public Shared Function L_fnObtenerLosPagos(_numi As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnCobranzasObtenerLasVentasACredito(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "TC005C  CATEGORIA"
    ...
    Public Shared Function L_prObtenerCategoriaZona(zona As Integer) As Integer
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 4))
        _listParam.Add(New Datos.DParametro("@canumi", zona))
    ...
    Public Shared Function L_prActualizarCategoriaZona(zona As Integer, catpre As Integer) As Integer
        Dim _resultado As Integer
        '@canumi ,@canombre ,@cadesc ,@caimg ,@newFecha ,@newHora ,@cauact
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@canumi", zona))
        _listParam.Add(New Datos.DParametro("@caest", catpre))
        _listParam.Add(New Datos.DParametro("@cauact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC005C", _listParam)
    ...
    Public Shared Function L_prGeneralZonas() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC005C", _listParam)
    ...
    Public Shared Function L_prCoordenadasClientes() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 61))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC005C", _listParam)
    ...
    Public Shared Function L_prReasignarCliente(cliente As Integer, zona As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@canumi", cliente))
        _listParam.Add(New Datos.DParametro("@caest", zona))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TC005C", _listParam)
        Return _Tabla
    End Function
#End Region
...
#Region "REPORTE DE VENTAS"
    Public Shared Function L_prListarPrevendedor(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@almacen", sucursal))
    ...
    Public Shared Function L_prListarClientes() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prListarProductos() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 31))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
    ...
    Public Shared Function L_prListarCoberturaVentas2(fechaI As String, fechaF As String, zona As Integer, vendedor As Integer, prov As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        ...
        _listParam.Add(New Datos.DParametro("@distribuidor", zona))
        _listParam.Add(New Datos.DParametro("@prevendedor", vendedor))
        _listParam.Add(New Datos.DParametro("@proveedor", prov))
        _Tabla = D_ProcedimientoConParam("sp_Mam_ReporteVentas", _listParam)
        Return _Tabla
    End Function

    Public Shared Function L_prListarReporteCobertura(fechaI As String, fechaF As String, zona As Integer, vendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_prListarEfectividadVentasDetallado(fechaI As String, fechaF As String, vendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 21))
        _listParam.Add(New Datos.DParametro("@fechaI", fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prListarDistribuidor(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 6))
        _listParam.Add(New Datos.DParametro("@almacen", sucursal))
    ...
    Public Shared Function L_prPedidoTipoVenta(numi As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 41))
        _listParam.Add(New Datos.DParametro("@numi", numi))
    ...
    Public Shared Function L_prObtenerDetallePedido2(numi As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 181))
        _listParam.Add(New Datos.DParametro("@numi", numi))
    ...
    Public Shared Function TraerGastosEntreFechas(_fechaI As String, _FechaF As String) As Double
        Dim _Tabla As DataTable
        ...
        If _Tabla.Rows.Count > 0 Then
            gastos = _Tabla.Rows(0).Item("gastos")
        Else
            gastos = 0
        End If
    ...
    Public Shared Function L_prListarReportePEdidosVsCostoUnVendedor(_fechaI As String, _FechaF As String, numiVendedor As String, codCli As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasTodosPrevendedores(_fechaI As String, _FechaF As String, usuario As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 2))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function L_prReporteVentasProductos(_fechaI As String, _FechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasTodosDistribuidores(_fechaI As String, _FechaF As String, ususario As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 4))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteVentasUnoPrevendedores(_fechaI As String, _FechaF As String, _codPrevendedor As String, usuario As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 3))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
    ...
    Public Shared Function L_prReporteVentasUnoDistribuidor(_fechaI As String, _FechaF As String, _codPrevendedor As String, usuario As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 5))
        _listParam.Add(New Datos.DParametro("@fechaI", _fechaI))
...
#Region "VENTAS ESTADISTICOS"
    Public Shared Function L_fnObtenerVendedores(_fechaI As String, _fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerVentasVendedores(_fechaI As String, _fechaF As String, _numiVendedor As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnObtenerCLientes(_fechaI As String, _fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnObtenerVentasClientes(_fechaI As String, _fechaF As String, _numiCliente As Integer, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "VENTAS GRAFICAS"
    Public Shared Function L_prVentasGraficaVendedorMes(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prVentasGraficaVendedorAlmacen(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prVentasGraficaVendedorRendimiento(fechaI As String, fechaF As String, dt As DataTable) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteCreditoClienteTodosCuentas(fechaI As String, fechaF As String, _numiCliente As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prReporteCreditoGeneralRes(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteCreditoClienteRes(fechaI As String, fechaF As String, codcli As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_prReporteCreditoClienteUnaCuentas(_numiCredito As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prVentasGraficaListarVendedores(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "Prestamo de equipo vs ventas"
    ...
    Public Shared Function L_fnVentaClientePorMes(bandera As String, anho As String, mes As String, codCliente As String, nomCliente As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
...
#End Region
    ...
    Public Shared Function L_fnReporteVentaAdmin(fechaI As String, fechaF As String, est As Integer, rep As Integer, vende As Integer, cliente As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        _listParam.Add(New Datos.DParametro("@idRepartidor", rep))
        _listParam.Add(New Datos.DParametro("@idVendedor", vende))
        _listParam.Add(New Datos.DParametro("@idCliente", cliente))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("MAM_ReporteVentaAdministrativo", _listParam)
        Return _Tabla
    End Function
...
#Region "EMPRESA"
    ...
    Public Shared Function L_prEmpresaGeneralPil() As DataTable
        Dim _Tabla As DataTable
...
#Region "ESTADOS TABLA TO001D"
    ...
    Public Shared Function L_EliminarTO001DEstado7(_oanumi As String) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function validarStockProducto(producto As Integer, cant As Double, sucursal As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim res As Boolean
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 8))
        _listPalam.Add(New Datos.DParametro("@estado", sucursal))
        _listPalam.Add(New Datos.DParametro("@oanumi", producto))
        _listPalam.Add(New Datos.DParametro("@credito", cant))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO001D", _listPalam)
...
#Region "Ingresos Egresos"
    ...
    Public Shared Function L_prIngresoEgresoGeneral2() As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 311))
        _listParam.Add(New Datos.DParametro("@ieuact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TIE001", _listParam)
    ...
    Public Shared Function L_prListarChoferesIngresosEgresos(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
...
#Region "Despacho"
    Public Shared Function ListarChoferesDespacho(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@cemp", sucursal))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
    ...
    Public Shared Function ListarUsuariosDespacho(sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function ReporteStockActual(almacen As Integer, mayorCero As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 9))
        _listParam.Add(New Datos.DParametro("@almacen", almacen))
        _listParam.Add(New Datos.DParametro("@numi", mayorCero))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_despacho", _listParam)
    ...
    Public Shared Function ListaPedidosDespachoF(estado As Integer, chofer As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function ListaPedidosDespachoFacturasA(estado As Integer, chofer As Integer, fechaI As String, fechaF As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function ObtenerFacturas(fechaI As String, fechaF As String, sucursal As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function ListaPedidosNotadeVenta(pedido As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function ReajustarMontos(pedido As Integer, contado As Double, credito As Double, transferencia As Double) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 45))
        _listParam.Add(New Datos.DParametro("@oanumi", pedido))
        _listParam.Add(New Datos.DParametro("@contado2", contado))
        _listParam.Add(New Datos.DParametro("@credito", credito))
...
#Region "Facturacion"
    ...
    Public Shared Function GrabarTFV001(pedido As Integer, fecha As String, factura As String, cuf As String,
                                        nit As String, cliente As String, subtotal As Double, total As Double,
                                        codcontrol As String, cufd As String, leyenda As String,
                                        nitemisor As String, printurl As String, siatid As String,
                                        siaturl As String, fact As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function TraerFacturaID(nit As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 41))
        _listParam.Add(New Datos.DParametro("@numi", nit))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        Return _Tabla
    End Function

    Public Shared Function TraerFacturaID2(nit As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
    ...
    Public Shared Function L_fnTraerClientes(nit As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 42))
        _listParam.Add(New Datos.DParametro("@pedido", nit))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
        Return _Tabla
    End Function
    Public Shared Function retornarEstadoFactura(id As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@estado", id))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_despacho", _listParam)
    ...
    Public Shared Function TraerLinkFacturacion(id As Integer) As DataTable
        Dim _Tabla As DataTable
        Dim _listParam As New List(Of Datos.DParametro)

        _listParam.Add(New Datos.DParametro("@tipo", 10))
        _listParam.Add(New Datos.DParametro("@cod1", id))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_mam_despacho", _listParam)
...
#Region "Sucursales"
    Public Shared Function L_fnTraerSucursales() As DataTable
        Dim _Tabla As DataTable
