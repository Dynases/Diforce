            ...
            If JGr_DetallePedido.RowCount < 100 Then
                If JGr_Productos.CurrentRow.Cells("iacant").Value > 0 Then
                    ...
                    If (Not existe) Then
                        ...
                        caconv = Convert.ToString(JGr_Productos.CurrentRow.Cells("caconv").Value)
            ...
            If (e.Column.Index = JGr_DetallePedido.RootTable.Columns("Cantidad").Index) Or (e.Column.Index = JGr_DetallePedido.RootTable.Columns("Precio").Index) Then
                ...
                Else
                    If (JGr_DetallePedido.GetValue("Cantidad") > 0) Then
                        ...
                        If atributo = -1 Then
                            JGr_DetallePedido.CurrentRow.Cells("Cajas").Value = 1 / conv
                        ...
                        Else
                            JGr_DetallePedido.CurrentRow.Cells("Cajas").Value = cantidad / conv
                ...
                End If
            End If
            If (e.Column.Index = JGr_DetallePedido.RootTable.Columns("Cajas").Index) Then

                If (Not IsNumeric(JGr_DetallePedido.GetValue("Cajas")) Or JGr_DetallePedido.GetValue("Cajas").ToString = String.Empty) Then

                    JGr_DetallePedido.CurrentRow.Cells("Cantidad").Value = 1 / JGr_DetallePedido.CurrentRow.Cells("caconv").Value = 1
                    JGr_DetallePedido.CurrentRow.Cells("Monto").Value = JGr_DetallePedido.CurrentRow.Cells("Precio").Value
                    JGr_DetallePedido.CurrentRow.Cells("Total").Value = JGr_DetallePedido.CurrentRow.Cells("Precio").Value - JGr_DetallePedido.GetValue("Descuento")
