...
Public Class R01_VentaEfectivaCliente
...
#Region "METODOS PRIVADOS"
    Public Sub _prIniciarTodo()
        ...
        Me.Text = "REPORTE EFECTIVIDAD POR CLIENTE"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        _dt = L_prReporteVentasEfectividadCliente(tbFechaI.Value.ToString("dd/MM/yyyy"), tbFechaF.Value.ToString("dd/MM/yyyy"), IIf(CheckTodosVendedor.Checked, -1, tbCodigoVendedor.Text))
        Return
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New R_VentasEfectividadCliente
