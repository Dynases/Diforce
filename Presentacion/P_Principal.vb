...
#Region "Metodos Privados"
    ...
    Private Sub _prIniciarTodo()
        ...
        Dim banderaPil As Boolean = True
    ...
    Private Sub actualizarConexion(tipo As Integer)
    ...
    Private Sub EmpresaSeleccionPil()
        Dim frmEmpresa As New P_EmpresasPil
        frmEmpresa.ShowDialog()
        If frmEmpresa.ok = False Then
            Me.Close()
            Exit Sub
    ...
    Private Sub _prLeerArchivoConfig(tipoInicio As Integer)
        ...
        gs_NombreBD1 = Archivo(3).Split("=")(1).Trim
        gs_NombreBD = Archivo(4).Split("=")(1).Trim
        gs_CarpetaRaiz = Archivo(5).Split("=")(1).Trim
        'gs_NombreBD2 = Archivo(6).Split("=")(1).Trim
        'gs_NombreBD3 = Archivo(7).Split("=")(1).Trim
        ...
        If tipoInicio = 1 Then
            ...
            'gs_ClaveSql = DescifradoCesar(gs_ClaveSql, 7)
    ...
    Function DescifradoCesar(texto As String, desplazamiento As Integer) As String
        Return CifradoCesar(texto, 26 - (desplazamiento Mod 26))
    End Function
...
#Region "Compra"
    ...
    Private Sub btMonitoreoVisita_Click(sender As Object, e As EventArgs) Handles btMonitoreoVisita.Click
        Dim frm As New MoitoreoVisita
        'frm._nameButton = btMonitoreoVisita.Name
        'frm._modulo = FP_Pedido
        frm.Show()
    End Sub

    Private Sub btVentasDetalladas_Click(sender As Object, e As EventArgs) Handles btVentasDetalladas.Click
        Dim frm As New R01_VentasDetallado
        frm._modulo = FP_CRM
        frm._nameButton = btVentasDetalladas.Name
        frm.Show()
    ...
    Private Sub btTablaVentas_Click(sender As Object, e As EventArgs) Handles btTablaVentas.Click
    ...
    Private Sub btTablaCobertura_Click(sender As Object, e As EventArgs) Handles btTablaCobertura.Click
