        ...
        If (index <= DgjBusqueda.GetRows.Count - 1 And index >= 0) Then
            If (BoNavegar) Then
                With DgjBusqueda
                    ...
                    Me.cbCatPre.Value = .GetValue("lacatpre")
    ...
    Private Sub P_prGrabarRegistro()
        ...
        If (BoNuevo) Then
            If (P_fnValidarGrabacion()) Then
                ...
                L_ZonaCabecera_Grabar(TbCodigo.Text, CbCiudad.Value, CbProvincia.Value, CbZona.Value, TbColor.Text, cbCatPre.Value)
                'grabar detalle
                Dim i As Integer
                Dim lati, longi As Double
        ...
        ElseIf (BoModificar) Then
            If (P_fnValidarGrabacion()) Then
                ...
                Dim CategoriaAnteior As Integer = L_prObtenerCategoriaZona(TbCodigo.Text)
                L_ZonaCabacera_Modificar(TbCodigo.Text, CbCiudad.Value, CbProvincia.Value, CbZona.Value, TbColor.Text, cbCatPre.Value)
                'grabar detalle
                L_ZonaDetallePuntos_Borrar(TbCodigo.Text)
                Dim i As Integer
                Dim lati, longi As Double
                ...
                '------------------------------------------------------- ACTUALIZAR CATEGORIA PARA LOS CLIENTES DE LA ZONA--------------------------------------------------
                If cbCatPre.Value <> CategoriaAnteior Then
                    Dim ef = New Efecto

                    ef.tipo = 2
                    ef.Context = "mensaje principal".ToUpper
                    ef.Header = "La categoria de precio se actualizo para la zona ¿Desea actualzar la categoria de precio para todos los clientes de la zona?".ToUpper
                    ef.ShowDialog()
                    Dim bandera As Boolean = False
                    bandera = ef.band
                    If (bandera = True) Then
                        Dim res As Boolean = L_prActualizarCategoriaZona(TbCodigo.Text, cbCatPre.Value)
                    End If
                End If
...
#End Region
    ...
    Private Sub ReasignarzZonas()
     ...
     New Tuple(Of Double, Double)(-21.530116, -64.720899),
New Tuple(Of Double, Double)(-21.529907, -64.721092),
New Tuple(Of Double, Double)(-21.529558, -64.721189),
New Tuple(Of Double, Double)(-21.529148, -64.721264),
New Tuple(Of Double, Double)(-21.528879, -64.721414),
New Tuple(Of Double, Double)(-21.5284, -64.721135),
New Tuple(Of Double, Double)(-21.52847, -64.72092),
New Tuple(Of Double, Double)(-21.528779, -64.720362),
New Tuple(Of Double, Double)(-21.52313, -64.718013),
New Tuple(Of Double, Double)(-21.522591, -64.722798),
New Tuple(Of Double, Double)(-21.522232, -64.723442),
New Tuple(Of Double, Double)(-21.521054, -64.72327),
New Tuple(Of Double, Double)(-21.519856, -64.723248),
New Tuple(Of Double, Double)(-21.519118, -64.723442),
New Tuple(Of Double, Double)(-21.5181, -64.722798),
New Tuple(Of Double, Double)(-21.517541, -64.721875),
New Tuple(Of Double, Double)(-21.516962, -64.72091),
New Tuple(Of Double, Double)(-21.516363, -64.719687),
New Tuple(Of Double, Double)(-21.515505, -64.718657),
New Tuple(Of Double, Double)(-21.514926, -64.71827),
New Tuple(Of Double, Double)(-21.514267, -64.71885),
New Tuple(Of Double, Double)(-21.513329, -64.719408),
New Tuple(Of Double, Double)(-21.512211, -64.718614),
New Tuple(Of Double, Double)(-21.511293, -64.71782),
New Tuple(Of Double, Double)(-21.510374, -64.718206),
New Tuple(Of Double, Double)(-21.511512, -64.713528),
New Tuple(Of Double, Double)(-21.514467, -64.714386),
New Tuple(Of Double, Double)(-21.515964, -64.71473),
New Tuple(Of Double, Double)(-21.5181, -64.715524),
New Tuple(Of Double, Double)(-21.518818, -64.715803),
New Tuple(Of Double, Double)(-21.520156, -64.716468),
New Tuple(Of Double, Double)(-21.520755, -64.716725),
New Tuple(Of Double, Double)(-21.522332, -64.717348),
New Tuple(Of Double, Double)(-21.522911, -64.717648),
New Tuple(Of Double, Double)(-21.525466, -64.718807)
    }

        'Dim poligono2 As New List(Of Tuple(Of Double, Double)) From {
        'New Tuple(Of Double, Double)(-19.6303, -63.561401),
        'New Tuple(Of Double, Double)(-19.627066, -63.579941),
        'New Tuple(Of Double, Double)(-19.618658, -63.613586),
        'New Tuple(Of Double, Double)(-19.621245, -63.632126),
        'New Tuple(Of Double, Double)(-19.623186, -63.658905),
        'New Tuple(Of Double, Double)(-19.619305, -63.687057),
        'New Tuple(Of Double, Double)(-19.63418, -63.698044),
        'New Tuple(Of Double, Double)(-19.655521, -63.69873),
        'New Tuple(Of Double, Double)(-19.677505, -63.694611),
        'New Tuple(Of Double, Double)(-19.706597, -63.691177),
        'New Tuple(Of Double, Double)(-19.725342, -63.688431),
        'New Tuple(Of Double, Double)(-19.740208, -63.687057),
        'New Tuple(Of Double, Double)(-19.752487, -63.678818),
        'New Tuple(Of Double, Double)(-19.765411, -63.680191),
        'New Tuple(Of Double, Double)(-19.785442, -63.668518),
        'New Tuple(Of Double, Double)(-19.807408, -63.656158),
        'New Tuple(Of Double, Double)(-19.830017, -63.624573),
        'New Tuple(Of Double, Double)(-19.845519, -63.610153),
        'New Tuple(Of Double, Double)(-19.862956, -63.595734),
        'New Tuple(Of Double, Double)(-19.888786, -63.586807),
        'New Tuple(Of Double, Double)(-19.917194, -63.580627),
        'New Tuple(Of Double, Double)(-19.930105, -63.569641),
        'New Tuple(Of Double, Double)(-19.945597, -63.561401),
        'New Tuple(Of Double, Double)(-19.959796, -63.551788),
        'New Tuple(Of Double, Double)(-19.972703, -63.546982),
        'New Tuple(Of Double, Double)(-19.988191, -63.546295),
        'New Tuple(Of Double, Double)(-19.99916, -63.546295),
        'New Tuple(Of Double, Double)(-20.013355, -63.546982),
        'New Tuple(Of Double, Double)(-20.019807, -63.548355),
        'New Tuple(Of Double, Double)(-20.034, -63.545609),
        'New Tuple(Of Double, Double)(-20.047546, -63.546982),
        'New Tuple(Of Double, Double)(-20.056576, -63.546982),
        'New Tuple(Of Double, Double)(-20.064316, -63.542862),
        'New Tuple(Of Double, Double)(-20.08044, -63.532562),
        'New Tuple(Of Double, Double)(-20.089468, -63.524323),
        'New Tuple(Of Double, Double)(-20.106234, -63.513336),
        'New Tuple(Of Double, Double)(-20.11784, -63.505783),
        'New Tuple(Of Double, Double)(-20.129445, -63.503723),
        'New Tuple(Of Double, Double)(-20.143628, -63.497543),
        'New Tuple(Of Double, Double)(-20.164899, -63.493423),
        'New Tuple(Of Double, Double)(-20.196479, -63.490677),
        'New Tuple(Of Double, Double)(-20.2171, -63.487244),
        'New Tuple(Of Double, Double)(-20.235785, -63.48175),
        'New Tuple(Of Double, Double)(-20.253179, -63.470764),
        'New Tuple(Of Double, Double)(-20.270571, -63.469391),
        'New Tuple(Of Double, Double)(-20.297622, -63.469391),
        'New Tuple(Of Double, Double)(-20.311789, -63.470078),
        'New Tuple(Of Double, Double)(-20.324667, -63.467331),
        'New Tuple(Of Double, Double)(-20.334969, -63.468018),
        'New Tuple(Of Double, Double)(-20.340764, -63.467331),
        'New Tuple(Of Double, Double)(-20.354284, -63.465958),
        'New Tuple(Of Double, Double)(-20.370377, -63.453598),
        'New Tuple(Of Double, Double)(-20.380033, -63.464584),
        'New Tuple(Of Double, Double)(-20.390331, -63.485184),
        'New Tuple(Of Double, Double)(-20.401272, -63.499603),
        'New Tuple(Of Double, Double)(-20.412212, -63.51059),
        'New Tuple(Of Double, Double)(-20.424439, -63.525009),
        'New Tuple(Of Double, Double)(-20.431517, -63.535995),
        'New Tuple(Of Double, Double)(-20.434091, -63.549728),
        'New Tuple(Of Double, Double)(-20.445029, -63.553848),
        'New Tuple(Of Double, Double)(-20.455966, -63.552475),
        'New Tuple(Of Double, Double)(-20.480411, -63.543549),
        'New Tuple(Of Double, Double)(-20.471406, -63.50647),
        'New Tuple(Of Double, Double)(-20.466259, -63.479691),
        'New Tuple(Of Double, Double)(-20.419291, -63.420639),
        'New Tuple(Of Double, Double)(-20.396123, -63.406219),
        'New Tuple(Of Double, Double)(-20.410282, -63.38562),
        'New Tuple(Of Double, Double)(-20.416717, -63.358841),
        'New Tuple(Of Double, Double)(-20.421865, -63.334122),
        'New Tuple(Of Double, Double)(-20.43216, -63.318329),
        'New Tuple(Of Double, Double)(-20.444385, -63.29567),
        'New Tuple(Of Double, Double)(-20.462399, -63.28949),
        'New Tuple(Of Double, Double)(-20.476552, -63.288803),
        'New Tuple(Of Double, Double)(-20.490703, -63.288803),
        'New Tuple(Of Double, Double)(-20.498421, -63.288116),
        'New Tuple(Of Double, Double)(-20.495848, -63.262024),
        'New Tuple(Of Double, Double)(-20.48813, -63.237305),
        'New Tuple(Of Double, Double)(-20.481055, -63.216705),
        'New Tuple(Of Double, Double)(-20.470762, -63.202286),
        'New Tuple(Of Double, Double)(-20.440525, -63.197479),
        'New Tuple(Of Double, Double)(-20.399341, -63.197479),
        'New Tuple(Of Double, Double)(-20.356215, -63.202286),
        'New Tuple(Of Double, Double)(-20.33175, -63.224945),
        'New Tuple(Of Double, Double)(-20.334969, -63.244858),
        'New Tuple(Of Double, Double)(-20.346558, -63.259277),
        'New Tuple(Of Double, Double)(-20.358146, -63.286743),
        'New Tuple(Of Double, Double)(-20.367802, -63.299789),
        'New Tuple(Of Double, Double)(-20.371665, -63.329315),
        'New Tuple(Of Double, Double)(-20.377458, -63.351974),
        'New Tuple(Of Double, Double)(-20.367159, -63.38562),
        'New Tuple(Of Double, Double)(-20.342052, -63.417206),
        'New Tuple(Of Double, Double)(-20.306637, -63.429565),
        'New Tuple(Of Double, Double)(-20.263485, -63.431625),
        'New Tuple(Of Double, Double)(-20.227409, -63.439865),
        'New Tuple(Of Double, Double)(-20.192613, -63.452911),
        'New Tuple(Of Double, Double)(-20.15652, -63.460464),
        'New Tuple(Of Double, Double)(-20.122998, -63.466644),
        'New Tuple(Of Double, Double)(-20.093982, -63.470764),
        'New Tuple(Of Double, Double)(-20.068186, -63.486557),
        'New Tuple(Of Double, Double)(-20.046256, -63.498917),
        'New Tuple(Of Double, Double)(-20.025613, -63.50647),
        'New Tuple(Of Double, Double)(-19.995934, -63.50647),
        'New Tuple(Of Double, Double)(-19.961087, -63.509216),
        'New Tuple(Of Double, Double)(-19.927523, -63.509903),
        'New Tuple(Of Double, Double)(-19.899117, -63.514709),
        'New Tuple(Of Double, Double)(-19.86231, -63.525009),
        'New Tuple(Of Double, Double)(-19.827434, -63.532562),
        'New Tuple(Of Double, Double)(-19.795133, -63.540802),
        'New Tuple(Of Double, Double)(-19.764119, -63.542175),
        'New Tuple(Of Double, Double)(-19.726635, -63.542175),
        'New Tuple(Of Double, Double)(-19.693668, -63.540802),
        'New Tuple(Of Double, Double)(-19.660047, -63.538742),
        'New Tuple(Of Double, Double)(-19.6303, -63.544922)
        '}

        ' Definir el punto a verificar
        Dim PuntosClientes As DataTable = L_prCoordenadasClientes()

        For i = 0 To PuntosClientes.Rows.Count - 1 Step 1
            Dim lat As Double = PuntosClientes.Rows(i).Item("cclat")
            Dim longit As Double = PuntosClientes.Rows(i).Item("cclongi")
            Dim punto As New Tuple(Of Double, Double)(lat, longit)

            Dim resultado As Boolean
            resultado = PuntoEnPoligono(punto, poligono1)
            If resultado Then
                L_prReasignarCliente(PuntosClientes.Rows(i).Item("ccnumi"), 14)
                'Else
                '    resultado = PuntoEnPoligono(punto, poligono2)
                '    If resultado Then
                '        L_prReasignarCliente(PuntosClientes.Rows(i).Item("ccnumi"), 2)
                '    Else
                '        L_prReasignarCliente(PuntosClientes.Rows(i).Item("ccnumi"), 3)
                '    End If
        ...
        ' Llamar a la función para verificar si el punto está dentro del polígono


    End Sub
    Private Sub GroupPanel2_Click(sender As Object, e As EventArgs)
