...
#Region "Metodos y funciones generales"
    ...
    Private Sub P_prArmarGrillaBusqueda()
        ...
        With DgjBusqueda.RootTable.Columns(34)
            ...
            '.CellStyle.BackColor = Color.AliceBlue
        End With
        With DgjBusqueda.RootTable.Columns(35)
...
#End Region
    ...
    Private Sub P_ArmarGrillaSugerencia()
        ...
        With DgjSugerencia.RootTable.Columns(31)
            ...
            '.CellStyle.BackColor = Color.AliceBlue
        End With
        With DgjSugerencia.RootTable.Columns(32)
            .Caption = ""
            .Key = "uact"
            .Width = 100
            .HeaderStyle.Font = FtTitulo
            ...
            '.CellStyle.BackColor = Color.AliceBlue
        End With
        With DgjSugerencia.RootTable.Columns(33)
            .Caption = ""
            .Key = "uact"
            .Width = 100
            .HeaderStyle.Font = FtTitulo
            ...
            '.CellStyle.BackColor = Color.AliceBlue
        End With
        With DgjSugerencia.RootTable.Columns(34)
            .Caption = ""
            .Key = "uact"
            .Width = 100
            .HeaderStyle.Font = FtTitulo
        ...
        If (1 = 1) Then 'If(_directorio.ShowDialog = Windows.Forms.DialogResult.OK) Then
            ...
            Try
                ...
                For Each _col As GridEXColumn In DgjBusqueda.RootTable.Columns
                    If (_col.Index = 0 Or _col.Index = 2 Or _col.Index = 3 Or _col.Index = 4 Or _col.Index = 7 Or _col.Index = 14 Or _col.Index = 15 Or _col.Index = 35) Then
