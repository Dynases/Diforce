...
Public Class R_ReporteCobertura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReporteCobertura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReporteCobertura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReporteCobertura = New R_ReporteCobertura()
        rpt.Site = Me.Site
        Return rpt
    End Function
