...
Public Class R_ReciboCliente2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReciboCliente2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReciboCliente2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReciboCliente2 = New R_ReciboCliente2()
        rpt.Site = Me.Site
        Return rpt
    End Function
