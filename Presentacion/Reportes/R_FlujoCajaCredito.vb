...
Public Class R_FlujoCajaCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FlujoCajaCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FlujoCajaCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FlujoCajaCredito = New R_FlujoCajaCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
