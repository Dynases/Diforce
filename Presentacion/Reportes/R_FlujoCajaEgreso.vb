...
Public Class R_FlujoCajaEgreso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FlujoCajaEgreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FlujoCajaEgreso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FlujoCajaEgreso = New R_FlujoCajaEgreso()
        rpt.Site = Me.Site
        Return rpt
    End Function
