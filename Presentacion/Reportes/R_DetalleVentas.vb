...
Public Class R_DetalleVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_DetalleVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_DetalleVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_DetalleVentas = New R_DetalleVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
