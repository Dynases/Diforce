...
Public Class R_VentasDetallada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentasDetallada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasDetallada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasDetallada = New R_VentasDetallada()
        rpt.Site = Me.Site
        Return rpt
    End Function
