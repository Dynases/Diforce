...
Public Class R_FlujoCajaDetallado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_FlujoCajaDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_FlujoCajaDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_R_FlujoCajaCreditorpt_fechaI() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_R_FlujoCajaCreditorpt_FechaF() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_R_FlujoCajaEgresorpt_fechaI() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_R_FlujoCajaEgresorpt_FechaF() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_FlujoCajaDetallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FlujoCajaDetallado = New R_FlujoCajaDetallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
