...
Public Class R_ReporteVisitas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ReporteVisitas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ReporteVisitas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ReporteVisitas = New R_ReporteVisitas()
        rpt.Site = Me.Site
        Return rpt
    End Function
