...
Public Class R01_ReporteCobertura
...
#Region "METODOS PRIVADOS"
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        ...
        If (CheckTodosVendedor.Checked) Then
            _dt = L_prListarReporteCobertura(tbFechaI.Value.ToString("dd/MM/yyyy"), tbFechaF.Value.ToString("dd/MM/yyyy"), cbZona.Value, CInt(tbCodigoVendedor.Text))
            Return
        End If
    ...
    Private Sub _prCargarReporte()
        ...
        If (_dt.Rows.Count > 0) Then
            ...
            Dim objrep As New R_ReporteCobertura
