        ...
        For i = 0 To JGr_Registros2.RowCount - 1
            ...
            If estado = True Then
                ...
                If res Then
                    ...
                    cant = cant + 1
                Else
                    ToastNotification.Show(Me, "El pedido " + codPedido.ToString + " no se pudo entregar", My.Resources.GRABACION_EXITOSA, 5000, eToastGlowColor.Green, eToastPosition.TopCenter)
                End If
            End If
        Next
...
#End Region
    ...
    Private Sub P_ImprimirRecibos(numi As String, printerName As String)
        ...
        ' Validar si la impresora existe
        Dim isValidPrinter As Boolean = False
        ...
        ' Si la impresora es válida, asignarla y proceder a imprimir
        If isValidPrinter Then
            objrep.PrintOptions.PrinterName = printerName

            ' Verificar si la impresora se asignó correctamente
            If String.IsNullOrEmpty(objrep.PrintOptions.PrinterName) Then
                Throw New Exception("La impresora no se asignó correctamente.")
            End If

            ' Imprimir el reporte
            objrep.PrintToPrinter(1, False, 1, 1) ' Imprimir 1 copia, sin color, de la primera página
        Else
            ' Mostrar mensaje si la impresora no es válida
            MessageBox.Show("La impresora '" & printerName & "' no es válida o no está instalada.")
        End If
    End Sub
